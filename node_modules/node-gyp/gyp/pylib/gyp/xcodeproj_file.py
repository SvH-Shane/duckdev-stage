...
# Oddly, Xcode will quote any string with a run of tree or more underscores.
...
class PBXGroup(XCHierarchicalElement):
  ...
  def TakeOverOnlyChild(self, recurse=False):
    ...
    are groups.  If there are tree PBXGroups representing a, b, and c, with
...
class PBXProject(XCContainerPortal):
  ...
  def Children(self):
    ...
    # objects in a dictionary (that is itself in a list), and tree lines for
