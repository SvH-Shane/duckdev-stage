...
watchpack high level API doesn't map directly to watchers. Instead a tree level architecture ensures that for each directory only a single watcher exists.
